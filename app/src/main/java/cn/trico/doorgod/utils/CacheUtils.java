...
public final class CacheUtils {
    ...
    private static Map<String, CacheUtils> instanceMap = new HashMap<>();
    ...
    private static CacheUtils get(File cacheDir, long maxSize, int maxCount) {
        CacheUtils cacheUtil = instanceMap.get(cacheDir.getAbsolutePath() + getPid());
        if (cacheUtil == null) {
            cacheUtil = new CacheUtils(cacheDir, maxSize, maxCount);
        }
        return cacheUtil;
    }
    ...
    public class CaCheManager {
        ...
        private void clearCache() {
            remove(CacheKey.CURRENT_ELECTRICITY + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_USER) + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_DEVICE));//电量
            remove(CacheKey.CURRENT_LIST + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_USER) + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_DEVICE));//信息
            remove(CacheKey.CURRENT_HOME + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_USER) + RuntimeCache.getCurrentCache(App.getInstance(), CacheKey.CURRENT_DEVICE));//首页
        }
